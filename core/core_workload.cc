...
void CoreWorkload::BuildValues(std::vector<ycsbc::DB_BASE::KVPair> &values) {
  for (int i = 0; i < field_count_; ++i) {
    ycsbc::DB_BASE::KVPair pair;
...
void CoreWorkload::BuildUpdate(std::vector<ycsbc::DB_BASE::KVPair> &update) {
  ycsbc::DB_BASE::KVPair pair;
